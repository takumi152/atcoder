...
int main() {
  ...
  min_cost_flow_graph mcf(2006);
  // source -> r, g, b
  mcf.add_edge(2004, 2001, r, 0);
  mcf.add_edge(2004, 2002, g, 0);
  mcf.add_edge(2004, 2003, b, 0);
  // r, g, b -> 0 to 2000 -> sink
  // r = 900
  // g = 1000
  // b = 1100
  for (int i = 0; i <= 2000; i++) {
    mcf.add_edge(2001, i, 1, abs(i - 900));
    mcf.add_edge(2002, i, 1, abs(i - 1000));
    mcf.add_edge(2003, i, 1, abs(i - 1100));
    mcf.add_edge(i, 2005, 1, 0);
  }

  auto res = mcf.flow(2004, 2005);
